...
for col in tqdm( categorical_columns_v2 ):
    ...
    # Label-Encoding을 fit
    lbl.fit( concat_select[col].astype(str) )
    concat_select[col] = lbl.transform(concat_select[col].astype(str))
    label_encoders[col] = lbl           # 나중에 후처리를 위해 레이블인코더를 저장해주겠습니다.

concat_select.head(1)        # 레이블인코딩이 된 모습입니다.
...
file_name = 'base2.6(test, train diff resolve,fix)'
