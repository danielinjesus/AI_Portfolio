...
file_name = '8_full_addr_gu_dong_base_'
...
dt_train = dt_train[['전용면적(㎡)', '계약년월', '도로명', '층', 'full_addr', 'target']]
dt_test = dt_test[['전용면적(㎡)', '계약년월', '도로명', '층', 'full_addr']]
